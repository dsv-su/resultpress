...
<a href="/project/{{$project->id}}/update" class="btn btn-outline-secondary @if ($project->hasDraft()) disabled @endif btn-sm">Write an update <i class="fas fa-folder-plus"></i></a>
