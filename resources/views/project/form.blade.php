    ...
    <form action="{{ route('project_update', $project) }}" method="POST">
        ...
        <div class="form-group">
            ...
            <div class=" ">
                <div class="form-row">
                    <div class="col-5">
                        ...
                        @error('project_name')<div class="text-danger">{{ $errors->first('project_name') }}</div>
                        @enderror
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group col-12">
                        ...
                        <textarea rows="4"
                            ...
                            type="text">{{ old('project_description', empty($project) ? '' : $project->description) }}</textarea>
                        @error('project_description')<div class="text-danger">
            ...
            <div class="form-group">
                ...
                <div>
                    <table class="table table-sm" id="activities_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="activity_description[]" class="form-control form-control-sm"
                                    value="{{$activity->description}}"></td>
                            <td><input type="date" name="activity_start[]" value="{{$activity->start->toDateString()}}"
                                    class="form-control form-control-sm">
                            </td>
                            <td><input type="date" name="activity_end[]" value="{{$activity->end->toDateString()}}"
                ...
                <div>
                    <table class="table table-sm" id="outputs_table">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="output_indicator[]" value="{{$output->indicator}}"
                                    class="form-control form-control-sm">
                            </td>
                            <td><input type="text" name="output_target[]" class="form-control form-control-sm"
                ...
                <div class="col">
                    <br>
                    <input class="btn btn-primary btn-lg" @empty($project->id) value="SAVE" @else value="UPDATE"
                    @endempty
                    type="submit">
                </div>
