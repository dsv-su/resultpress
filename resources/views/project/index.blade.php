...
@section('content')
<table id="example" class="table table-sm table-striped table-bordered" style="width:100%" data-order='[[ 0, "desc" ]]'
    data-page-length='25'>
    <thead>
        <tr>
            <th>Id</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center">
                <a href="/project/{{$project->id}}" class="btn btn-outline-success btn-sm"><i
